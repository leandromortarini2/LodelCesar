...
import useConfigStateCredit from "./hook/useConfigOutDated";

export default function StateCreditView() {
  const {
    configTable,
    selectedShare,
    setSelectedShare,
  ...
  return (
    <section className="h-screen space-y-7 w-full bg-white-primary p-6 flex flex-col">
      ...
      <div className="w-full flex justify-between items-center">
        <CustomeTitle
          title="Créditos Acordados/Rechazados"
          type="h2"
          font="semibold"
        />
        ...
        <div className="flex gap-5 items-end">
          <Select
            options={["A/R", "Aprobado", "Rechazado"]}
            value={selectedShare}
